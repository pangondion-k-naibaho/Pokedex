package com.pokedex.client.view.custom_ui
...
import com.pokedex.client.databinding.LayoutSearchInputBinding

class InputSearchView: ConstraintLayout {
    private lateinit var mContext: Context
    private lateinit var binding: LayoutSearchInputBinding
    ...
    private fun init(context: Context, attributeSet: AttributeSet?){
        ...
        binding = LayoutSearchInputBinding.bind(
            LayoutInflater.from(mContext)
                .inflate(R.layout.layout_search_input, this, true)
        )
